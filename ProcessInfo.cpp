...
double CProcess::GetWsPrivate_PDH(ProcessListData *pData)//byte
{
	...
	if(MemUsage == 0)
	{
		MemUsage =  GetWsPrivate(pData->PID) ; //������һ�ַ�����ȡ
	}
...
//
//		status = MyNtQuerySystemInformation ( SystemProcessInformation, lpBuf, nSize, &bytesreturned ) ;	// ö�ٽ�����Ϣ
//
//		if ( !NT_SUCCESS(status) )
//		{			
//			if ( status == STATUS_INFO_LENGTH_MISMATCH ) // ����Ƿ񷵻ػ�����������
//			{
//				nSize += DEF_BUF_SIZE ;
//				delete lpBuf ;
//				lpBuf =NULL;
...
int CProcess::GetThreadCount(ProcessListData *pData )
{
	...
	//{
	//	//MSB_S(L"CreateToolhelp32Snapshot ����ʧ��");
	//	return 0 ;
	//}
	////�������̿��գ�������ʾÿ�����̵���Ϣ
...
CString CProcess::GetProcCommandLine(DWORD PID)
{
	...
	HANDLE hProcess = OpenProcess( PROCESS_QUERY_INFORMATION|PROCESS_VM_READ    ,FALSE,PID);  //ע�� PROCESS_ALL_ACCESS �ᵼ�� ����������޷���ȡ��Ϣ  //PROCESS_TERMINATE  PROCESS_ALL_ACCESS| PROCESS_QUERY_INFORMATION | PROCESS_QUERY_LIMITED_INFORMATION   /PROCESS_VM_READ  PROCESS_QUERY_LIMITED_INFORMATION
...
double CProcess::GetWsPrivate(DWORD PID )//����byte��
{
	double WsPrivate = 0;
