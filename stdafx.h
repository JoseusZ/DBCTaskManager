...
#define  UM_BASELISTOK   (WM_USER+104) //������Ľ����б�������ɣ�
#define  UM_ALLINFO_OK   (WM_USER+105) //����ȫ����Ϣ������ɣ�
#define  UM_TOGGLE_TMMODE   (WM_USER+106) 

#define  UM_ADD_PROC_SIMPEL_LIST   (WM_USER+107) //���ӵ�simple list 
//#define  UM_DEL_PROC_SIMPEL_LIST   (WM_USER+108) //�� simple list  ɾ��
...
struct  COLUMNSTATUS_EX
{
	...
	BYTE Redraw;//һ�������־�����Ƿ��ػ����
	BOOL Cool;
	BOOL IsHiddenColumn; //δ���õ���
	BYTE iOrder;
	//CString StrItem;
	WCHAR StrItem[5]; // headerctrl ��ʾ�� �ٷֱ� 
	BYTE Align;
	BOOL DrawInSubItem ; //��������� �Ƿ���ʾ���������֣�
	float Percents;
	int ColWStore;//���ڱ���ָ���ʾ��ʱ���еĿ���
...
//		if(ZwResumeProcess(hProc)!=0) //������ô˺���ʧ�ܣ���֤����������
//		{
//			  mbox(hProc)
//			break;
//		}
